...
public class RoundImageView extends ImageView {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (imageType == TYPE_CIRCLE) {
            ...
            setMeasuredDimension(imgPainterWidth+borderWidth*2, imgPainterWidth+borderWidth*2);
        }
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (imageType == TYPE_CORNER) {
            ...
            int painterWidth = imgRadius+borderWidth;
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (imageType == TYPE_CORNER) {
            ...
            imageRect = new RectF(borderWidth, borderWidth, w-borderWidth, h-borderWidth);
        }
    }
    ...
    public void setBorderWidth(int widht){
        int pxVal = dp2px(widht);
        if (this.borderWidth != pxVal) {
            this.borderWidth = pxVal;
            invalidate();
        }
    }
