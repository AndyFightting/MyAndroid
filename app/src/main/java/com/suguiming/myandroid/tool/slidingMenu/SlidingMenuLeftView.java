 ...
 */
public class SlidingMenuLeftView extends RelativeLayout implements View.OnClickListener{
    ...
    public SlidingMenuLeftView(SlidingMenuActivity activity,SlidingMenu slidingMenu){
        super(activity);
        this.activity = activity;
        this.slidingMenu = slidingMenu;

        LayoutInflater inflater =LayoutInflater.from(activity);
        inflater.inflate(R.layout.sliding_menu_left_frame,this);
